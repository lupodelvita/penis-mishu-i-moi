    ...
    <div className="min-h-screen bg-background nw-grid-bg flex items-center justify-center relative overflow-hidden">
      ...
      <div className="relative w-full max-w-sm px-4">
        ...
        <div className="border border-border bg-card/80 backdrop-blur-sm p-8">
          ...
          <p className="text-xs text-slate-600 mb-6 font-mono">Access your workspace</p>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            >
              {loading ? <span className="font-mono text-xs tracking-wider">Authenticating...</span> : 'Sign In →'}
            </button>
          </form>

          <div className="mt-6 pt-5 border-t border-border flex items-center justify-center gap-1.5">
            <span className="text-xs text-slate-700">No account?</span>
            <Link href="/auth/register" className="text-xs text-sky-400 hover:text-sky-300 transition-colors">Register →</Link>
          </div>
        </div>
