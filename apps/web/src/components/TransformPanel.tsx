...
const LOCAL_TRANSFORMS: APITransform[] = [
  ...
  { id: 'phone_intel', name: 'Phone Intelligence', description: 'Carrier, HLR, WhatsApp/Telegram', category: 'Phone', icon: '📞', inputTypes: ['phone_number'], outputTypes: ['organization', 'location', 'social_profile'], estimatedTime: '~8 сек', estimatedMs: 8000 },
